...
export const ventures: Venture[] = [
  ...
  },
  {
    ...
    description: 'Good at Scale Studio is the creative and operational engine behind everything I build. A venture studio built on a simple thesis: do genuinely good work, at scale. Home to the 12x12 challenge: 12 ventures in 12 months, and the infrastructure, brand, and systems that make it possible.',
    year: '2025–',
    tags: ['Studio', 'Brand'],
  },
  {
    ...
    shortName: 'the-grid',
    status: 'BUILD',
    description: 'AI agent infrastructure for venture building at GAS Studio. Autonomous systems that compress months of startup groundwork into days, handling research, drafting, ops workflows, and decision support. The internal backbone powering the 12x12 challenge from the inside.',
    year: '2026–',
  ...
  },
  {
    ...
    shortName: 'blue-hut',
    status: 'CONCEPT',
    description: 'A beach cafe concept bringing community-forward events and seasonal snack options to McKinley Beach in Milwaukee, WI. Built around the idea that great food and great people belong together outdoors. A neighborhood staple in the making.',
    year: '2026–',
    tags: ['Concept', 'Food & Bev', 'Community'],
  },
  {
    id: 'atb',
    name: 'ATB',
